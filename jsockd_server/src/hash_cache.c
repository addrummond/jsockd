...
HashCacheBucket *add_to_hash_cache(HashCacheBucket *buckets, size_t bucket_size,
                                   int n_bits, HashCacheUid uid, void *object,
...
HashCacheBucket *get_hash_cache_entry(HashCacheBucket *buckets,
