...
generate_qjsc_wrapper() {
    ...
    echo "        # Add dummy signature to simplify read logic in jsockd_server."
...
for platform in $platforms; do
    ...
    case "$platform" in
        native)
            ...
            cp qjs ../../tools-bin
            cp qjsc ../../tools-bin
            generate_qjsc_wrapper qjsc > ../../tools-bin/jsockd_compile_es6_module
            cp ../../tools-bin/jsockd_compile_es6_module ../../tools-bin/jsockd_compile_es6_module_${OS}_${ARCH}
        ...
        mac_arm64)
            ...
            generate_qjsc_wrapper qjsc > ../../tools-bin/jsockd_compile_es6_module_Darwin_arm64
            chmod +x ../../tools-bin/jsockd_compile_es6_module_Darwin_arm64
        ...
        linux_arm64)
            ...
            generate_qjsc_wrapper qjsc > ../../tools-bin/jsockd_compile_es6_module_Linux_arm64
            chmod +x ../../tools-bin/jsockd_compile_es6_module_Linux_arm64
