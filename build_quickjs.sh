...
for platform in $platforms; do
    ...
    case "$platform" in
        ...
        windows_x64_msvc)
            ...
            /c/Program\ Files\ */GnuWin32/bin/make.exe CC=cl CFLAGS='/std:c17 /experimental:c11atomics -Ipthreads-win32/include -D__maybe_unused -Dforce_inline' LDFLAGS='-Lpthreads-win32/lib'
            ;;
        mac_arm64)
