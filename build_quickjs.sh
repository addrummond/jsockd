...
for platform in $platforms; do
    ...
    case "$platform" in
        ...
        windows_x64_msvc)
            ...
            /c/Program\ Files\ */GnuWin32/bin/make.exe CC=cl HOST_CC=cl CFLAGS='/nologo /std:c17 /experimental:c11atomics -Ipthreads-win32/include -D_WINSOCKAPI_' LDFLAGS='/LIBPATH:pthreads-win32/lib/x64 pthreadVC2.lib'
            ;;
        mac_arm64)
